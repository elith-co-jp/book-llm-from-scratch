...
![fig.1 LLMモデル一覧](https://prod-files-secure.s3.us-west-2.amazonaws.com/f32ca4cc-631d-41b4-b55a-d4b4b3d47037/e057822d-7541-4fca-a24e-e7a3356b0617/Untitled.png)

fig.1 LLMモデル一覧

![image.png](attachment:a05bfd17-cae7-4a51-8ff1-897cca22eea6:image.png)

## アーキテクチャレベルでのLLM改善と効率化手法

### **Mixture of Experts（MoE）の標準化**

MoEアーキテクチャは2024-2025年に業界標準として確立されました。GPT-4が8つのエキスパート（各220B）を使用していることが判明し、DeepSeek-V3の「共有エキスパート」概念、LLaMA 4の交互MoE/密モジュール設計など、多様な実装が開発されています。
