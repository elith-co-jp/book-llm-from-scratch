...
2 GPU（NVIDIA RTX 6000 Ada Generation）環境で、DDP（torchrun）と DeepSpeed ZeRO Stage 2 の学習時間を比較しました。

| 手法 | 総学習時間 | スループット |
|------|-----------|-------------|
| DDP (torchrun) | xxx分xx秒 | xx.xx samples/sec |
| DeepSpeed ZeRO Stage 2 | 187分25秒 | 29.35 samples/sec |

両手法とも同じ学習設定（3エポック、グローバルバッチサイズ256）で実行しています。ZeRO Stage 2 はオプティマイザ状態と勾配を GPU 間で分散するため、メモリ効率が向上します。今回の実験規模では学習時間に大きな差は見られませんが、より大きなモデルやバッチサイズを扱う場合に ZeRO の恩恵が顕著になります。
...
学習完了後のモデルによる生成例を示します。各プロンプトに対して、モデルが生成した続きの文章です。

**プロンプト1:** 吾輩は猫である。名前はまだ無い。

> 私は、その昔、の家の前を通りかかったことがあるが、この家とは縁もゆかりもない犬で、今の私が、あの家を尋ねるはずはないのだと思ったほどだ。しかし、そう思えるぐらいに、私の眼にはこの家は私を安心させてくれ...

**プロンプト2:** 明治時代の

> 五百円札、一万円札などというのを見かけます。これはで、お尻から二十五銭だけ出ているわけですが、それはさすがに面白いと私も思っていました。そのほかはどんな品物でも、五千円以上出す人がいなければ成り立たな...

**プロンプト3:** 東京の街には

> 四十 七十五 八十七 七十八 と数えた。 三 私は三年前、東京から二里ばかり離れた田舎へ越したのであった。 その頃、私が見たものは皆、都会で見るよりも遥かに美しいものであったが、その中で一番心惹かれた...

**プロンプト4:** 先生は言った。「

> 君も知っての通り、僕は学問をやらないのだ」 「いやだ。しかし、お前は学問が好きなんだよ。そうして、それを世間に認めて貰うために勉強するのだ」と、その人は言った。「でも、そんなことは大した問題じゃありま...

生成されたテキストは文法的に正しい日本語で、青空文庫の文体を反映した小説風の文章になっています。ただし、「明治時代の」というプロンプトに対して時代と直接関係のない内容が生成されるなど、プロンプトの意図を完全に捉えられていない場合もあります。これは事前学習の限界であり、第5章で扱うアラインメント（指示に従うための学習）によって改善されます。
